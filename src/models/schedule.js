...
const model = {
  ...
  addSchedule: (movie_id, location, price, start_date, end_date, time) => {
    return new Promise((resolve, reject) => {
      db.query(
        `insert into schedule (movie_id, location, price, start_date, end_date, time) 
            values($1, $2, $3, $4, $5, $6)`,
        [movie_id, location, price, start_date, end_date, time]
      )
        .then((res) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      db.query(
        `update schedule set 
                    ...
                    updated_at = now() 
                    where id = $7`,
        [movie_id, location, price, start_date, end_date, time, id]
      )
        .then((res) => {
